  ...
  return (
    <section className="relative flex min-h-[50vh] flex-col items-center justify-center px-4 py-16 md:min-h-[60vh]">
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        <div className="absolute top-1/2 left-1/2 h-[400px] w-[600px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-[#c9a962]/5 blur-[100px]" />
      </div>

      {/* Logo */}
      <div className="relative z-10 text-center">
        <h1 className="text-5xl font-light tracking-[0.4em] text-[#c9a962] md:text-7xl lg:text-8xl">
          ETERNA
        </h1>
      ...
      {/* Tagline */}
      <p className="relative z-10 mt-8 max-w-md text-center text-sm leading-relaxed text-[#737373] md:text-base">
        시대를 초월한 가치를 지닌
        <br />
        엄선된 럭셔리 아이템을 소개합니다
      </p>
